...
counter = counter +1;
    ...
    for (var i=0; i < attrArray.length; i++) {
      ...
      if (id === rawID) {
        ...
        for (var elem=0; elem < name.length; elem++) {
          ...
          if (counter%2!=0) {
            var code='<!--row ' + row + ' starts-->' + '<tr><td align="center" style="border: 1px solid #dddddd; border-collapse: collapse;"><a href="https://www.rakuten.com'+ link + '_'+ id + '-xfas?eeid=${eeid}&utm_source=rakuten&utm_medium=email&utm_campaign=${utmCampaign}&utm_content=${utmDate}&ebtoken=${Recipient.jwt_token}"><img src="http://dreammail.edgesuite.net/PMB/Ebates/Promos/20190304_OnTrend_LC/american_eagle.png" alt="' + alt + '" border="0" style="display:block;" width="237"/></a></td>';
            document.getElementById("write").innerText += code;
            row = row +1;
          }
          else {
            var code2='<td align="center" style="border: 1px solid #dddddd; border-collapse: collapse;"><a href="https://www.rakuten.com'+ link + '_'+ id + '-xfas?eeid=${eeid}&utm_source=rakuten&utm_medium=email&utm_campaign=${utmCampaign}&utm_content=${utmDate}&ebtoken=${Recipient.jwt_token}"><img src="http://dreammail.edgesuite.net/PMB/Ebates/Promos/20190304_OnTrend_LC/american_eagle.png" alt="' + alt + '" border="0" style="display:block;" width="237"/></a></td></tr>';
    ...
    if (counter%2!=0) {
      var code3='<tr><td align="center" style="border: 1px solid #dddddd; border-collapse: collapse;"><span style="font-size:12px">' + alert + '</span></td>';
      document.getElementById("write").innerText += code3;
    }
    else {
      var code4='<td align="center" style="border: 1px solid #dddddd; border-collapse: collapse;"><span style="font-size:12px">' + alert + '</span></td></tr>';
